...
{
    [Area("AdminPublic")]
    public class DistrictsMediaManagementController : ExtraAdminController
    {
        public DistrictsMediaManagementController(IHostEnvironment _hostEnvironment,
            ...
            try
            {
                if (districtFileUploadPVMList != null)
                {
                    if (districtFileUploadPVMList.Count > 0)
                    {
                        ...
                        string districtFolder = hostEnvironment.ContentRootPath + "\\wwwroot\\Files\\DistrictFiles\\" + domainSettings.DomainName + "\\" + districtId + "\\Media";
                    ...
                    if (jsonResultWithRecordObjectVM != null)
                    {
                        if (jsonResultWithRecordObjectVM.Result.Equals("OK"))
                        {
                            ...
                            if (record != null)
                            {
                                ...
                                districtFilesVM.DistrictFileType = "media";
        ...
        public IActionResult CompleteDeleteDistrictFiles(int DistrictFileId = 0)
        {
            ...
            try
            {
                ...
                string districtFolder = hostEnvironment.ContentRootPath + "\\wwwroot\\Files\\DistrictFiles\\" + domainSettings.DomainName + "\\" + districtFilesVM.DistrictId + "\\Media";
