...
{
    [Area("AdminPublic")]
    public class DistrictsMapsManagementController : ExtraAdminController
    {
        public DistrictsMapsManagementController(IHostEnvironment _hostEnvironment,
        ...
        public IActionResult AddToDistrictFiles(int Id = 0)
        {
            ...
            if (ViewData["DataBackUrl"] == null)
            {
                ViewData["DataBackUrl"] = "/AdminPublic/DistrictsMapsManagement/Index/" + districtsVM.DistrictId;
            ...
            try
            {
                if (districtFileUploadPVMList != null)
                {
                    if (districtFileUploadPVMList.Count > 0)
                    {
                        ...
                        string districtFolder = hostEnvironment.ContentRootPath + "\\wwwroot\\Files\\DistrictFiles\\" + domainSettings.DomainName + "\\" + districtId + "\\Maps";
                    ...
                    if (jsonResultWithRecordObjectVM != null)
                    {
                        if (jsonResultWithRecordObjectVM.Result.Equals("OK"))
                        {
                            ...
                            if (record != null)
                            {
                                ...
                                districtFilesVM.DistrictFileType = "maps";
        ...
        public IActionResult CompleteDeleteDistrictFiles(int DistrictFileId = 0)
        {
            ...
            try
            {
                ...
                string districtFolder = hostEnvironment.ContentRootPath + "\\wwwroot\\Files\\DistrictFiles\\" + domainSettings.DomainName + "\\" + districtFilesVM.DistrictId + "\\Maps";
