...
{
    [Area("AdminPublic")]
    public class ZonesDocsManagementController : ExtraAdminController
    {
        public ZonesDocsManagementController(IHostEnvironment _hostEnvironment,
        ...
        public IActionResult AddToZoneFiles(int Id = 0)
        {
            ...
            if (ViewData["DataBackUrl"] == null)
            {
                ViewData["DataBackUrl"] = "/AdminPublic/ZonesDocsManagement/Index/" + ZonesVM.ZoneId;
            ...
            try
            {
                if (ZoneFileUploadPVMList != null)
                {
                    if (ZoneFileUploadPVMList.Count > 0)
                    {
                        ...
                        string ZoneFolder = hostEnvironment.ContentRootPath + "\\wwwroot\\Files\\ZoneFiles\\" + domainSettings.DomainName + "\\" + ZoneId + "\\Docs";
        ...
        public IActionResult CompleteDeleteZoneFiles(int ZoneFileId = 0)
        {
            ...
            try
            {
                ...
                string ZoneFolder = hostEnvironment.ContentRootPath + "\\wwwroot\\Files\\ZoneFiles\\" + domainSettings.DomainName + "\\" + ZoneFilesVM.ZoneId + "\\Docs";
        ...
        public async Task<IActionResult> FileDownload(int Id = 0)
        {
            ...
            if (!string.IsNullOrEmpty(ZoneFilesVM.ZoneFilePath))
            {
                ...
                if (System.IO.File.Exists(ZoneFolder + "\\" + ZoneFilesVM.ZoneFilePath))
                {
                    ...
                    var filePath = ZoneFolder + "\\" + ZoneFilesVM.ZoneFilePath;
