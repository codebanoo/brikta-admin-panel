...
{
    [Area("AdminPublic")]
    public class ZonesMediaManagementController : ExtraAdminController
    {
        public ZonesMediaManagementController(IHostEnvironment _hostEnvironment,
            ...
            try
            {
                if (ZoneFileUploadPVMList != null)
                {
                    if (ZoneFileUploadPVMList.Count > 0)
                    {
                        ...
                        string ZoneFolder = hostEnvironment.ContentRootPath + "\\wwwroot\\Files\\ZoneFiles\\" + domainSettings.DomainName + "\\" + ZoneId + "\\Media";
                    ...
                    if (jsonResultWithRecordObjectVM != null)
                    {
                        if (jsonResultWithRecordObjectVM.Result.Equals("OK"))
                        {
                            ...
                            if (record != null)
                            {
                                ...
                                ZoneFilesVM.ZoneFileType = "media";
        ...
        public IActionResult CompleteDeleteZoneFiles(int ZoneFileId = 0)
        {
            ...
            try
            {
                ...
                string ZoneFolder = hostEnvironment.ContentRootPath + "\\wwwroot\\Files\\ZoneFiles\\" + domainSettings.DomainName + "\\" + ZoneFilesVM.ZoneId + "\\Media";
