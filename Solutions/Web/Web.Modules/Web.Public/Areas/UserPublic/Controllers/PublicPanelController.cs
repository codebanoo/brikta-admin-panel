...
namespace Web.Public.Areas.UserPublic.Controllers
{
    [Area("UserPublic")]
    public class PublicPanelController : ExtraUsersController
    {
        public PublicPanelController(IHostEnvironment _hostEnvironment,
