...
{
    [Area("AdminTeniaco")]
    public class PropertiesDocsManagementController : ExtraAdminController
    {
        public PropertiesDocsManagementController(IHostEnvironment _hostEnvironment,
        ...
        public IActionResult AddToPropertyFiles(int Id = 0)
        {
            ...
            if (ViewData["DataBackUrl"] == null)
            {
                ViewData["DataBackUrl"] = "/AdminTeniaco/PropertiesDocsManagement/Index/" + propertiesVM.PropertyId;
            }
