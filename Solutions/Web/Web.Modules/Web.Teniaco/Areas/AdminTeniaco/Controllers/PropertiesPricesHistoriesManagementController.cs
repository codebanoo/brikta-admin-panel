...
{
    [Area("AdminTeniaco")]
    public class PropertiesPricesHistoriesManagementController : ExtraAdminController
    {
        public PropertiesPricesHistoriesManagementController(IHostEnvironment _hostEnvironment,
        ...
        public IActionResult Index(int id = 0)
        {
            ...
            if (ViewData["Properties"] == null)
            {
                ...
                ViewData["Properties"] = propertiesVM;
            }
        ...
        [HttpPost]
        [AjaxOnly]
        public IActionResult GetListOfPropertiesPricesHistories(
        int jtStartIndex = 0,
        int jtPageSize = 10,
        int propertyId = 0,
        string jtSorting = null)
        {
            ...
            try
            {
                string serviceUrl = teniacoApiUrl + "/api/PropertiesPricesHistoriesManagement/GetListOfPropertiesPricesHistories";
                ...
                responseApiCaller = new TeniacoApiCaller(serviceUrl).GetListOfPropertiesPricesHistories(getListOfPropertiesPricesHistoriesPVM);
