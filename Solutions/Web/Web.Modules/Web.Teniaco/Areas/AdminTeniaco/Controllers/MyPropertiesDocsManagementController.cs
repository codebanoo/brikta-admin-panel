...
{
    [Area("AdminTeniaco")]
    public class MyPropertiesDocsManagementController : ExtraAdminController
    {
        public MyPropertiesDocsManagementController(IHostEnvironment _hostEnvironment,
        ...
        public IActionResult Index(int Id = 0)
        {
            ...
            try
            {
                ...
                GetMyPropertyWithMyPropertyIdPVM getMyPropertyWithMyPropertyIdPVM = new GetMyPropertyWithMyPropertyIdPVM()
                {
                    PropertyId = Id,
                ...
                responseApiCaller = new TeniacoApiCaller(serviceUrl).GetMyPropertyWithMyPropertyId(getMyPropertyWithMyPropertyIdPVM);
            ...
            ViewData["MyPropertiesVM"] = MyPropertiesVM;
          ...
          string jtSorting = null)
        {
            ...
            try
            {
                ...
                GetListOfMyPropertyFilesPVM getListOfMyPropertyFilesPVM = new GetListOfMyPropertyFilesPVM()
                {
                    //ChildsUsersIds = consoleBusiness.GetDomainChildUserIdsWithStoredProcedure(this.userId.Value,
                    //    this.domainsSettings.DomainSettingId),
                    ChildsUsersIds = consoleBusiness.GetChildUserIdsMatchWithLevelIds(this.areaName, this.controllerName, this.actionName, this.userId.Value, this.parentUserId.Value,
                    ...
                    PropertyFileTitle = propertyFileTitle,
                    PropertyFileType = "docs",
                    jtSorting = jtSorting
                };

                responseApiCaller = new TeniacoApiCaller(serviceUrl).GetListOfMyPropertyFiles(getListOfMyPropertyFilesPVM);
        ...
        public IActionResult AddToMyPropertyFiles(int Id = 0)
        {
            ...
            if (ViewData["DataBackUrl"] == null)
            {
                ViewData["DataBackUrl"] = "/AdminTeniaco/MyPropertiesDocsManagement/Index/" + MyPropertiesVM.PropertyId;
            }
            ...
            try
            {
                if (propertyFileUploadPVMList != null)
                {
                    if (propertyFileUploadPVMList.Count > 0)
                    {
                        ...
                        string propertyFolder = hostEnvironment.ContentRootPath + "\\wwwroot\\Files\\PropertiesFiles\\" + domainSettings.DomainName + "\\" + propertyId + "\\Docs";
                    ...
                    if (jsonResultWithRecordObjectVM != null)
                    {
                        if (jsonResultWithRecordObjectVM.Result.Equals("OK"))
                        {
                            ...
                            if (record != null)
                            {
                                ...
                                propertyFilesVM.PropertyFileType = "docs";
        ...
        public IActionResult CompleteDeleteMyPropertyFiles(int PropertyFileId = 0)
        {
            ...
            try
            {
                ...
                string propertyFolder = hostEnvironment.ContentRootPath + "\\wwwroot\\Files\\PropertiesFiles\\" + domainSettings.DomainName + "\\" + propertyFilesVM.PropertyId + "\\Docs";
