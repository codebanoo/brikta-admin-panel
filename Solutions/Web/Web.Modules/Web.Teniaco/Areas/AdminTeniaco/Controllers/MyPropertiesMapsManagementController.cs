...
{
    [Area("AdminTeniaco")]
    public class MyPropertiesMapsManagementController : ExtraAdminController
    {
        public MyPropertiesMapsManagementController(IHostEnvironment _hostEnvironment,
        ...
        public IActionResult AddToMyPropertyFiles(int Id = 0)
        {
            ...
            if (ViewData["DataBackUrl"] == null)
            {
                ViewData["DataBackUrl"] = "/AdminTeniaco/MyPropertiesMapsManagement/Index/" + propertiesVM.PropertyId;
            }
