...
{
    [Area("AdminTeniaco")]
    public class PropertiesMediaManagementController : ExtraAdminController
    {
        public PropertiesMediaManagementController(IHostEnvironment _hostEnvironment,
     ...
     string propertyFileType = "")
        ...
        public async Task<ActionResult> AddToPropertyFiles(List<PropertyFileUploadPVM> propertyFileUploadPVMList,
            long propertyId,
