...
namespace Web.Automation.Areas.UserAutomation.Controllers
{
    ...
    public class StaffManagementController : ExtraAdminController
    {
        ...
        public IActionResult AddToStaff()
        {
            ...
            {
                ViewData["DataBackUrl"] = "/UserAutomation/StaffManagement/Index";
            }
        ...
        [AjaxOnly]
        [HttpPost]
        public IActionResult ToggleActivationStaff(int userId = 0)
        {
            ...
            try
            {
                ...
                //    "/api/StaffManagement/ToggleActivationStaff";
        ...
        [AjaxOnly]
        [HttpPost]
        public IActionResult TemporaryDeleteStaff(int userId = 0)
        {
            JsonResultObjectVM jsonResultObjectVM = new JsonResultObjectVM(new object() { });
        ...
        [AjaxOnly]
        [HttpPost]
        public IActionResult CompleteDeleteStaff(int userId = 0)
        {
            JsonResultObjectVM jsonResultObjectVM = new JsonResultObjectVM(new object() { });
