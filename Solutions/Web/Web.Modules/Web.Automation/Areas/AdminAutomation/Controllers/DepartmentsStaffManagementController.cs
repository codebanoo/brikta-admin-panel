    ...
    public class DepartmentsStaffManagementController : ExtraAdminController
    {
        ...
        public IActionResult GetAllDepartmentsStaffList()
        {
            ...
            try
            {
                ...
                serviceUrl = automationApiUrl + "/api/DepartmentsStaffManagement/GetAllDepartmentsStaffList";
            ...
            string jtSorting = null)
        {
            ...
            try
            {
                ...
                serviceUrl = automationApiUrl + "/api/DepartmentsStaffManagement/GetListOfDepartmentsStaff";
        ...
        public IActionResult AddToDepartmentsStaff(DepartmentsStaffVM departmentsStaffVM)
        {
            ...
            try
            {
                serviceUrl = automationApiUrl + "/api/DepartmentsStaffManagement/AddToDepartmentsStaff";
        ...
        public IActionResult GetDepartmentStaffWithDepartmentStaffId(int timesLimitationId)
        {
            ...
            try
            {
                serviceUrl = automationApiUrl + "/api/DepartmentsStaffManagement/GetDepartmentStaffWithDepartmentStaffId";
        ...
        public IActionResult UpdateDepartmentsStaff(DepartmentsStaffVM departmentsStaffVM)
        {
            try
            {
                ...
                {
                    serviceUrl = automationApiUrl + "/api/DepartmentsStaffManagement/UpdateDepartmentsStaff";
        ...
        public IActionResult TemporaryDeleteDepartmentsStaff(int departmentStaffId = 0)
        {
            ...
            try
            {
                serviceUrl = automationApiUrl + "/api/DepartmentsStaffManagement/TemporaryDeleteDepartmentsStaff";
        ...
        public IActionResult CompleteDeleteDepartmentsStaff(int departmentStaffId = 0)
        {
            ...
            try
            {
                serviceUrl = automationApiUrl + "/api/DepartmentsStaffManagement/CompleteDeleteDepartmentsStaff";
